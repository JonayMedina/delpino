  ...
  methods: {
              ...
              case 3:
                ...
                axios.post('/api/prices/store', me.price).then(function (resp) {
                  ...
                  if (error.response.status == 422) {
                    me.allErrors = error.response.data.errors; // let data = '';
    ...
    validatePrice: function validatePrice() {
      ...
      if (me.errListP.length >= 1) {
        Sfire.validateF(me.errListP); // Swal.fire({
        //     showClass: {
        ...
        //     title:'Falta(n) Datos',
        //     icon: 'error',
        //     imageUrl: me.barImage,
        //     imageWidth: 300,
        //     confirmButtonText: 'Aceptar!',
        //     confirmButtonColor: '#3085d6',
        //     html: `${me.errListP.map( er =>`<br><span class="mb-3"><i class="mdi-close-circle-outline mr-3 red"></i> ${er}</span>`)}`,
